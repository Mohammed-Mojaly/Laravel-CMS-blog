            ...
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><img src="{{get_gravatar($comment->email,50)}}" class="img-circle"> {!!$comment->user_id != '' ? '(Member)' : '' !!}</td>
                            <td>
                                <a href="{!! $comment->url != '' ? $comment->url : 'javascript:void(0);' !!}" target="_blank"> {{ $comment->name }} </a>
                            </td>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <a href="javascript:void(0);" onclick="if (confirm('Are you sure to delelte this comment ?')) {document.getElementById('comment-delete-{{$comment->id}}').submit();} else{return false;}" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
