...
<div class="card-body">
    ...
    {!! Form::open(['open' => 'admin.post_comments.index' , 'method' => 'get']) !!}
        ...
        <div class="row">
            ...
            <div class="col-2">
                ...
                <div class="form-group">
                    {!! Form::select('post_id' ,['' => '----'] + $post[0], old('post_id' , request()->input('post_id')) , ['class' => 'form-control'] ) !!}
                </div>
            ...
            <div class="col-2">
                ...
                <div class="form-group">
                    {!! Form::select('sort_by' ,['' => '----' ,  'id' => 'ID','name' => 'Name' , 'created_at' => 'Created date'], old('sort_by' , request()->input('sort_by')) , ['class' => 'form-control'] ) !!}
                </div>
