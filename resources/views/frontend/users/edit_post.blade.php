        ...
        <div class="row">
            <div class="col-lg-9 col-12">
                ...
                <div class="form-group">
                    ...
                    {!! Form::select('tags[]', $tagss[0]  ,old('tags' , $post->tags), ['class' => 'form-control selects', 'multiple' => 'multiple' , 'id' => 'select_all_tags']) !!}
                ...
                <div class="row">
                    <div class="col-4">
                        ...
                        {!! Form::select('category_id', ['' => '---'] + $categorie[0], old('category_id' ,$post->category_id), ['class' => 'form-control']) !!}
