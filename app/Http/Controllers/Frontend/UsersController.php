...
class UsersController extends Controller
{
    ...
    public function index()
    {
        ...
        $posts = auth()->user()->posts()->with(['media', 'category', 'user'])->withCount('comment')->orderBy('id', 'desc')->paginate(10);
        //dd($posts);
    ...
    public function update_info(Request $request)
    {
      ...
      //  dd($request->all());
        $validator = Validator::make($request->all(), [
            ...
            'user_image'         => 'nullable|image|max:2000,mimes:jpeg,jpg,png',
    ...
    public function create_post()
    {
        ...
        $tagss[] = $tags->toArray();
        return view('frontend.users.create_post', compact('categorie' , 'tagss'));
    }
    ...
    public function edit_post($post_id)
    {
        ...
        if ($post) {
            ...
            $categories = Category::whereStatus(1)->pluck('name', 'id');
            $categorie[] = $categories->toArray();
            return view('frontend.users.edit_post', compact('post', 'categorie' , 'tagss'));
        }
