...
class UsersController extends Controller
{
    ...
    public function index()
    {
        ...
        $limit_by = (isset(\request()->limit_by) && \request()->limit_by != '') ? \request()->limit_by : '9';
        ...
        $users->withCount('posts')->first();
        $users->withCount('comments')->first();
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($user) {
            ...
            if ($user_image = $request->file('user_image')) {
                ...
                Image::make($user_image->getRealPath())->resize(300, 300, null, function ($constraint) {
                    $constraint->aspectRatio();
                })->save($path, 100);
