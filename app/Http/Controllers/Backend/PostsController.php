...
class PostsController extends Controller
{
    ...
    public function index()
    {
        ...
        $posts = Post::with(['user', 'category', 'comment'])->wherePostType('post');
        if ($keyword != null) {
        ...
        $categorie[] = $categories->toArray();


        return view('backend.posts.index', compact('categorie' , 'posts' ));
...

    {
        ...
        $categorie[] = $categories->toArray();
        $tagss[] = $tags->toArray();
        return view('backend.posts.create', compact('categorie' ,'tagss'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->images && count($request->images) > 0) {
            ...
            foreach ($request->images as $file) {
                ...
                $filename = $post->slug . '-' . time() . '-' . $count . '.' . $file->getClientOriginalExtension();
    ...
    public function show($id)
    {
        ...
        $post = Post::with(['media','category' , 'user' , 'comment'])->whereId($id)->wherePostType('post')->first();
    ...
    public function edit($id)
    {
        ...
        $tagss[] = $tags->toArray();
        $categorie[] = $categories->toArray();
        return view('backend.posts.edit', compact('categorie', 'post' ,'tagss'));
    }
