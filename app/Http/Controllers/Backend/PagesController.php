...
class PagesController extends Controller
{
    public function index()
    {
        ...
        return view('backend.pages.index', compact('categorie' , 'pages' ));
    }
...

    {
        ...
        $categories = Category::orderBy('id', 'desc')->pluck('name', 'id');
        $categorie[] = $categories->toArray();
        return view('backend.pages.create', compact('categorie'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->images && count($request->images) > 0) {
            ...
            foreach ($request->images as $file) {
                ...
                $filename = $page->slug . '-' . time() . '-' . $count . '.' . $file->getClientOriginalExtension();
    ...
    public function edit($id)
    {
        ...
        $categorie[] = $categories->toArray();
        return view('backend.pages.edit', compact('categorie', 'page'));
    }
