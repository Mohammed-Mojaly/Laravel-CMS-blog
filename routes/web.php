...
Route::group(['middleware' => 'verified', 'as' => 'users.'], function () {
    ...
    Route::any('/user/notifications/get',               [FrontendNotificationsController::class, 'getNotification']);
...
Route::group(['prefix' => 'admin', 'as' => 'admin.'], function() {
    ...
    Route::group(['middleware' => ['roles', 'role:admin|editor']], function() {
        Route::any('/notifications/get',                [BackendNotificationsController::class, 'getNotification']);
